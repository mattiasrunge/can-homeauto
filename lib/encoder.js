...
//        console.log("Got msg... ", JSON.stringify(message)); 
        ...
        for (let n = 0; n < variableNodes.length; n++) {
            value = message.variables[variableNodes[n].name];
//console.log("Got variable node1... ", JSON.stringify(variableNodes[n]));
//console.log("Got variable node2... ", JSON.stringify(variableNodes[n].name));
//console.log("Got variable node3... ", value); 
            if (value === "") {
                continue;
            }
